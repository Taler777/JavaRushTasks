...
import static com.javarush.task.task24.task2409.Util.Company.Colins;
...
public class Util {
    ...
    static {
        ...
        jeansArray.add(new Object[]{3, Colins, 32, 6, 120.0});
    ...
    public static List<Jeans> getAllJeans() {
        ...
        for (Object[] obj : getJeansArray()) {
            ...
            } else if (Company.Colins == company) {
                jeans = new Colins(id, length, size, price);
            } else if (Company.CalvinKleinJeans == company) {
                jeans = new CalvinKleinJeans(id, length, size, price);
            }
            allJeans.add(jeans);
        }
        return allJeans;
